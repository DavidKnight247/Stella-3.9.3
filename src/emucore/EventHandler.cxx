...
#ifdef GCW0
        //emulate mouse button press in menus
 	if(myState != S_EMULATE && key == KBDK_LCTRL)
	{
		Int32 gcw_x2, gcw_y2;
		SDL_GetMouseState(&gcw_x2, &gcw_y2);
	        Int32 x = gcw_x2, y = gcw_y2;
...
////////////////////////////////////////////////////////////////////////
        ...
        if(myState != S_EMULATE)
	{
		...
		if(x_move > Joystick::deadzone())
		{
			move_right = 1;
			move_left  = 0;
		}
		else if(x_move < -Joystick::deadzone())
		{
			move_right = 0;
			move_left  = 1;
		}
		else	move_right = move_left  = 0;
       	        if(y_move > Joystick::deadzone())
		{
			move_down = 1;
			move_up   = 0;
		}
                else if(y_move < -Joystick::deadzone())
		{
			move_down = 0;
			move_up   = 1;
		}
		else	move_up = move_down = 0;
